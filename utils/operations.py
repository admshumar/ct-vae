...
def normalize(data):
    """
    Quick and dirty normalization method. Assumes that each element of data attains a maximum value of 255.
    :param data: A NumPy array.
    :return: A NumPy array of data normalized so that the maximum value is 1.
    """
    data = data / 255.
    return data
